...
IT Support need Read-Only (for troubleshooting, audit support — not operational access)
...
G-Finance-Analysts → nested into → DL-Finance-Share-Read → ACL on \\DC01\Finance-Shared
...
[x] Day 3 — Group Strategy & AGDLP Nesting Model (Complete)
